...
function new_captcha6()
{
var c_currentTime = new Date();
var c_miliseconds = c_currentTime.getTime();

document.getElementById('captcha6').src = '<?php echo APP_ROOT_URL; ?>image.php?x='+ c_miliseconds;
$("#s_code5").val(0);
}
</script>
<ul class="jobmainsec">
...
<h2>About you</h2>
		  ...
		  <dl>
				<dt>Security Code</dt>
				<dd>
				<img border="0" class="Border" id="captcha6" src="<?php echo APP_ROOT_URL; ?>image.php" alt="" /> &nbsp;<a href="JavaScript: new_captcha6();" style="text-decoration:none"><img border="0" alt="" src="<?php echo APP_ROOT_URL; ?>refresh.png" align="bottom" /></a><br>
				<input type="text" name="security_code" id="security_code"   class="inptxtsml mleft10" onKeyUp="javascript:return checkcode3(this.value);" />
				<input type="hidden" name="s_code5" id="s_code5" value="" />
				<span class="errormsg" id="err_security_code"></span>
		...
		<input type="image" src="../images/submit-button.gif"   />
		</span></dd>
		</dl>
		  </li>           
      </ul>
