	...
	<table width="89%" border="0" cellspacing="0" cellpadding="3" style="background:#dddddd;">
      ...
      <tr height="10">
		...
		<table cellpadding="2" cellspacing="2" border="0" width="100%">
		  ...
		  <tr><td><strong>Number of children :</strong></td><td><?php echo $_POST['quote_no_children']; ?></td></tr>
		  <tr><td><strong>Ages of children :</strong></td><td><?php echo $_POST['quote_age_children']; ?></td></tr>
